...
var rootCmd = &cobra.Command{
  Use:   "agenda",
  Short: "This is a meeting management application",
  Long: `agenda is a CLI application for managing meetings
You can use it to create, join, query, quit, and delete a meeting`,
